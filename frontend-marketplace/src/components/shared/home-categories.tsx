...
const defaultCategories: CategoryPill[] = [
  ...
  },
  {
    ...
    label: 'Pedir Comida',
    icon: '🍔',
    href: '/publicaciones?cat=comida',
    size: 'md',
  },
  {
    id: 'gasfiteria',
    label: 'Gasfitería Urgente',
    icon: '🔧',
    href: '/publicaciones?cat=gasfiteria',
    size: 'lg',
    offset: 'bottom',
  },
  {
    ...
    label: 'Viaje / Auto',
    icon: '🚗',
    href: '/publicaciones?cat=transporte',
    size: 'sm',
  },
  {
    id: 'electricidad',
    label: 'Electricista SEC',
    icon: '⚡',
    href: '/publicaciones?cat=electricidad',
    size: 'md',
    offset: 'top',
  },
  {
    id: 'legal',
    label: 'Abogado / Trámites',
    icon: '⚖️',
    href: '/publicaciones?cat=legal',
    size: 'lg',
    highlight: true,
  },
  {
    id: 'delivery',
    label: 'Reparto Express',
    icon: '🛵',
    href: '/publicaciones?cat=delivery',
    size: 'sm',
    offset: 'bottom',
  },
  {
    ...
    label: 'Aseo Hogar',
    icon: '🧹',
    href: '/publicaciones?cat=limpieza',
    size: 'md',
  },
  {
    id: 'articulos',
    label: 'Comprar / Vender Artículos',
    icon: '🛍️',
    href: '/publicaciones?cat=articulos',
    size: 'lg',
    offset: 'top',
  },
  {
    ...
    icon: '🐕',
    href: '/publicaciones?cat=mascotas',
    size: 'sm',
  },
  {
    id: 'pintura',
    label: 'Pintor de Casas',
    icon: '🎨',
    href: '/publicaciones?cat=pintura',
    size: 'md',
    offset: 'bottom',
  },
  {
    ...
    icon: '💻',
    href: '/publicaciones?cat=computacion',
    size: 'sm',
    highlight: true,
  },
  {
