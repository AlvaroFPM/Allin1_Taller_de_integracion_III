...
type Publicacion struct {
	...
	IDUsuarioVendedor uint      `gorm:"column:id_usuario_vendedor;not null;index" json:"id_usuario_vendedor"` // ID Lógico de IAM
	...
	TipoServicio      string    `gorm:"type:varchar(50);default:'OFERTA'" json:"tipo_servicio"` // OFERTA o DEMANDA
	...
	Estado            string    `gorm:"type:varchar(30);default:'ACTIVO'" json:"estado"` // ACTIVO, INACTIVO, ELIMINADO
	CreatedAt         time.Time `gorm:"column:fecha_creacion;autoCreateTime" json:"fecha_creacion"`
